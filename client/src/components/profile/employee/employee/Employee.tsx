...
const Employee: React.FC = () => {
    ...
    console.log('filterModel', filterModel, page);
    const { data, isFetching } = useGetEmployeesWithPaginationQuery({
        page,
        limit,
        sort,
        filter: filterModel,
    ...
    const onChange: TableProps<DataType>['onChange'] = (paginationConfig, filters, sorter) => {
        if (sorter) {
